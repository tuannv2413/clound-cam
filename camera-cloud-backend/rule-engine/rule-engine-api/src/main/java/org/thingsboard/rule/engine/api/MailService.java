...
public interface MailService {
    ...
    // dft add sendEmail to multi email function
    void sendEmail(TenantId tenantId, List<String> to, String subject, String message) throws ThingsboardException;
    ...
    void sendRecoverPasswordAsync(String passwordResetLink, String email, String name);
