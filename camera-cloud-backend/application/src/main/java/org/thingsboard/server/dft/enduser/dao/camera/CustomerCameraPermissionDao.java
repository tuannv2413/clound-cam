...
public interface CustomerCameraPermissionDao {

    List<CustomerCameraPermissionDto> getAllCustomerCameraPermissionV1(UUID boxId, UUID groupId, UUID clUserId, String cameraName, int noneGroup, UUID tenantId) throws ThingsboardException;
